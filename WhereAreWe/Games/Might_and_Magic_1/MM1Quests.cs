...
namespace WhereAreWe
{
    ...
    public static class MM1Bits
    {
        ...
        public static BitDesc WorthyDescription(object val) { return Description((Worthy)val); }

        public static BitDesc Description(Worthy wi)
        {
            switch (wi)
            {
                case Worthy.Intellect: return new BitDesc("Increase Intellect", MM1.Spots.PermIntellect, "Enter the square");
                case Worthy.Might: return new BitDesc("Increase Might", MM1.Spots.PermMight, "Enter the square");
                case Worthy.Personality: return new BitDesc("Increase Personality", MM1.Spots.PermPersonality, "Enter the square");
                case Worthy.Endurance: return new BitDesc("Increase Endurance", MM1.Spots.PermEndurance, "Enter the square");
                case Worthy.Speed: return new BitDesc("Increase Speed", MM1.Spots.PermSpeed, "Enter the square");
                case Worthy.Accuracy: return new BitDesc("Increase Accuracy", MM1.Spots.PermAccuracy, "Enter the square");
                case Worthy.Luck: return new BitDesc("Increase Luck", MM1.Spots.PermLuck, "Enter the square");
                case Worthy.Visited: return new BitDesc("Be deemed worthy", MM1.Spots.ClericsSouth, "Enter the square");
            }
        ...
        public static BitDesc MainDescription(object val) { return Description((MainQuest)val); }

        public static BitDesc Description(MainQuest astral)
        {
            switch (astral)
            {
                case MainQuest.Scroll: return new BitDesc("Accept the Vellum Scroll in Sorpigal", MM1.Spots.Courier, "Visit Agar in Erliquin", MM1.Spots.Agar);
                case MainQuest.Agar: return new BitDesc("Visit Agar in Erliquin", MM1.Spots.Agar, "Visit Telgoran in Dusk", MM1.Spots.Telgoran);
                case MainQuest.Telgoran: return new BitDesc("Visit Telgoran in Dusk", MM1.Spots.Telgoran, "Find Zam", MM1.Spots.Zam).AddChecked("Find Zom", MM1.Spots.Zom);
                case MainQuest.Zam: return new BitDesc("Visit Zam in Portsmith", MM1.Spots.Zam, "Enter the Square", MM1.Spots.RubyWhistle);
                case MainQuest.Zom: return new BitDesc("Visit Zom in Algary", MM1.Spots.Zom, "Enter the Square", MM1.Spots.RubyWhistle);
                case MainQuest.Whistle: return new BitDesc("Find the Ruby Whistle", MM1.Spots.RubyWhistle, "Enter the Square", MM1.Spots.Stronghold);
                case MainQuest.Stronghold: return new BitDesc("Enter the Stronghold", MM1.Spots.Stronghold, "Talk to the canine", MM1.Spots.Canine);
                case MainQuest.Canine: return new BitDesc("Talk to the canine", MM1.Spots.Stronghold, "Talk to the Courier", MM1.Spots.Courier);
                case MainQuest.Projector1: return new BitDesc("Visit Astral Projector 1", MM1.Spots.Projector1, "Use the Keycard", MM1.Spots.InnerSanctumDoor);
                case MainQuest.Projector2: return new BitDesc("Visit Astral Projector 2", MM1.Spots.Projector1, "Use the Keycard", MM1.Spots.InnerSanctumDoor);
                case MainQuest.Projector3: return new BitDesc("Visit Astral Projector 3", MM1.Spots.Projector1, "Use the Keycard", MM1.Spots.InnerSanctumDoor);
                case MainQuest.Projector4: return new BitDesc("Visit Astral Projector 4", MM1.Spots.Projector1, "Use the Keycard", MM1.Spots.InnerSanctumDoor);
                case MainQuest.Projector5: return new BitDesc("Visit Astral Projector 5", MM1.Spots.Projector1, "Use the Keycard", MM1.Spots.InnerSanctumDoor);
                case MainQuest.Sheltem: return new BitDesc("Enter SHELTEM", MM1.Spots.SoulMaze, "Use the Keycard", MM1.Spots.InnerSanctum);
                case MainQuest.FinishGame: return new BitDesc("Visit the Inner Sanctum", MM1.Spots.InnerSanctum, "Visit the Gates to Another World", MM1.Spots.GatesToAnotherWorld);
            }
            return BitDesc.Empty;
        }
        ...
        public enum Castle
        {
            InspectronComplete1 = 7,
            InspectronComplete2 = 6,
            InspectronComplete3 = 5,
            InspectronComplete4 = 4,
            InspectronComplete5 = 3,
            InspectronComplete6 = 2,
            InspectronComplete7 = 1,
            InspectronCompleteAll = 0,
            HackerComplete1 = 15,
            HackerComplete2 = 14,
            HackerComplete3 = 13,
            HackerComplete4 = 12,
            ...
            HackerComplete7 = 9,
            HackerCompleteAll = 8,
            IronfistComplete1 = 23,
            IronfistComplete2 = 22,
            IronfistComplete3 = 21,
            IronfistComplete4 = 20,
            IronfistComplete5 = 19,
            IronfistComplete6 = 18,
            IronfistComplete7 = 17,
            IronfistCompleteAll = 16,
            InspectronReward1 = 31,
            InspectronReward2 = 30,
            InspectronReward3 = 29,
            InspectronReward4 = 28,
            InspectronReward5 = 27,
            InspectronReward6 = 26,
            InspectronReward7 = 25,
            InspectronRewardAll = 24,
            HackerReward1 = 39,
            HackerReward2 = 38,
            HackerReward3 = 37,
            HackerReward4 = 36,
            ...
            IronfistReward6 = 42,
            IronfistReward7 = 41,
            IronfistRewardAll = 40,
        }

        public static BitDesc CastleDescription(object val) { return Description((Castle)val); }

        public static BitDesc Description(Castle castleBit)
        {
            string strWhen = "Enter the square";
            switch (castleBit)
            {
                case Castle.InspectronComplete1: return new BitDesc("Leave the Ancient Wizard Lair", MM1.Spots.AncientWizardLair, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronComplete2: return new BitDesc("Visit Blythe's Peak", MM1.Spots.BlithesPeak, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronComplete3: return new BitDesc("Present Cactus Nectar to Lord Inspectron", MM1.Spots.CactusNectar, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronComplete4: return new BitDesc("Find the Shrine of Okzar", MM1.Spots.Okzar, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronComplete5: return new BitDesc("Find the Fountain of Dragadune", MM1.Spots.DragaduneFountain, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronComplete6: return new BitDesc("Answer \"CRYSTAL\"", MM1.Spots.RubyRiddle, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronComplete7: return new BitDesc("Defeat the Gray Minotaur", MM1.Spots.GrayMinotaur, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronCompleteAll: return new BitDesc("Restart Lord Inspectron's quests", MM1.Spots.Inspectron, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.HackerComplete1: return new BitDesc("Present Garlic to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerComplete2: return new BitDesc("Present Wolfsbane to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerComplete3: return new BitDesc("Present Belladonna to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerComplete4: return new BitDesc("Present Medusa Head to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerComplete5: return new BitDesc("Present Wyvern Eye to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerComplete6: return new BitDesc("Present Dragons Tooth to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerComplete7: return new BitDesc("Present Ring of Okrim to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerCompleteAll: return new BitDesc("Finish Lord Hacker's quests", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.IronfistComplete1: return new BitDesc("Leave the Stronghold", MM1.Spots.RavenStronghold, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistComplete2: return new BitDesc("Present Map of Desert to Lord Ironfist", MM1.Spots.Ironfist, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistComplete3: return new BitDesc("Defeat the Succubus Queen", MM1.Spots.Succubus, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistComplete4: return new BitDesc("Find Pirate Cove A or B", MM1.Spots.PirateA, "Talk to Lord Ironfist", MM1.Spots.Ironfist).AddSet("Find Pirate Cove A or B", MM1.Spots.PirateB);
                case Castle.IronfistComplete5: return new BitDesc("Find the Jolly Raven", MM1.Spots.JollyRaven, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistComplete6: return new BitDesc("Defeat the Pirate Ghost Ship", MM1.Spots.PirateGhost, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistComplete7: return new BitDesc("Defeat Lord Archer", MM1.Spots.LordArcher, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistCompleteAll: return new BitDesc("Restart Lord Ironfist's quests", MM1.Spots.Ironfist, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.InspectronReward1: return new BitDesc("Return after visiting the Ancient Wizard Lair", MM1.Spots.Inspectron, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronReward2: return new BitDesc("Return after visiting Blythe's Peak", MM1.Spots.Inspectron, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronReward3: return new BitDesc("Present Cactus Nectar to Lord Inspectron", MM1.Spots.Inspectron, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronReward4: return new BitDesc("Return after visiting the Shrine of Okzar", MM1.Spots.Inspectron, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronReward5: return new BitDesc("Return after visiting the Fountain of Dragadune", MM1.Spots.Inspectron, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronReward6: return new BitDesc("Return after answering the Riddle of the Ruby", MM1.Spots.Inspectron, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronReward7: return new BitDesc("Return after defeating the Gray Minotaur", MM1.Spots.Inspectron, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.InspectronRewardAll: return new BitDesc("Restart Lord Inspectron's quests", MM1.Spots.Inspectron, "Talk to Lord Inspectron", MM1.Spots.Inspectron);
                case Castle.HackerReward1: return new BitDesc("Present Garlic to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerReward2: return new BitDesc("Present Wolfsbane to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerReward3: return new BitDesc("Present Belladonna to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerReward4: return new BitDesc("Present Medusa Head to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerReward5: return new BitDesc("Present Wyvern Eye to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerReward6: return new BitDesc("Present Dragons Tooth to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerReward7: return new BitDesc("Present Ring of Okrim to Lord Hacker", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.HackerRewardAll: return new BitDesc("Finish Lord Hacker's quests", MM1.Spots.Hacker, "Talk to Lord Hacker", MM1.Spots.Hacker);
                case Castle.IronfistReward1: return new BitDesc("Return after visiting the Stronghold", MM1.Spots.Ironfist, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistReward2: return new BitDesc("Present Map of Desert to Lord Ironfist", MM1.Spots.Ironfist, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistReward3: return new BitDesc("Return after defeating the Succubus Queen", MM1.Spots.Ironfist, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistReward4: return new BitDesc("Return after finding Pirate Cove A or B", MM1.Spots.Ironfist, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistReward5: return new BitDesc("Return after finding the Jolly Raven", MM1.Spots.Ironfist, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistReward6: return new BitDesc("Return after defeating the Pirate Ghost Ship", MM1.Spots.Ironfist, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistReward7: return new BitDesc("Return after defeating Lord Archer", MM1.Spots.Ironfist, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
                case Castle.IronfistRewardAll: return new BitDesc("Restart Lord Ironfist's quests", MM1.Spots.Ironfist, "Talk to Lord Ironfist", MM1.Spots.Ironfist);
            }
    ...
    public class MM1QuestInfo : QuestInfo<MM1Quest>
    {
        ...
        public override BasicQuest[] GetQuests()
        {
            ...
            InnerSanctum.AddLocations(new QuestLocation("Obtain the Eye of Goros", MM1.Spots.EyeOfGoros),
                new QuestLocation("Obtain a King's Pass", MM1.Spots.Percella),
        ...
        public override void SetQuests(QuestData data, int iOverrideCharAddress = -1)
        {
            ...
            else
            {
                ...
                if (party.CurrentPartyHasItem(MM1ItemIndex.KingsPass))
                    Main |= MM1QuestStates.Main.HaveKingsPass;
            ...
            bool bKingsPass = Main.HasFlag(MM1QuestStates.Main.HaveKingsPass);
