...
namespace WhereAreWe
{
    ...
    public class MM2SpellCost : MMSpellCost
    {
        ...
        public override string LongString { get { return ShortString; } }
    ...
    public class MM2Spell : MMSpell
    {
        ...
        public override bool MayHaveDuplicateNames { get { return true; } }  // e.g. "Light" is both a Sorcerer and a Cleric spell
        ...
        {
            return new Keys[] { Keys.C, Keys.D0 + Level, Keys.D0 + Number, Keys.Enter };
        }
