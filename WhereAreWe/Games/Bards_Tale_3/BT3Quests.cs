...
namespace WhereAreWe
{
    public static class BT3Bits
    {
        ...
        public static BitDesc Description(Scripts bit)
        {
            switch (bit)
            {
                case Scripts.WaterAcorn_VT30102: return new BitDesc("Use container with \"Water of Life\"", BT3.Spots.VT3_0102_Acorn, enter);
                case Scripts.PlantAcorn_VT30102: return new BitDesc("Use \"Acorn\"", BT3.Spots.VT3_0102_Acorn, enter);
                case Scripts.GetNightspear_VT40304: return new BitDesc("Obtain \"Nightspear\"", BT3.Spots.VT4_0304_Nightspear, enter);
                case Scripts.DefeatTslotha_FP20211: return new BitDesc("Defeat \"Tslotha Garnath\"", BT3.Spots.FP2_0211_Tslotha, enter);
                ...
                case Scripts.Grove_CB0709: return new BitDesc("Give \"Tslotha's Head\" to King", BT3.Spots.CB_0811_King, enter).AddChecked(enter, BT3.Spots.CB_0709_King);
                case Scripts.TalkKing_CB0811: return new BitDesc("Meet the King", BT3.Spots.CB_0709_King, enter);
                case Scripts.LEVIWhiteTowerDoor_IK11109: return new BitDesc("Cast \"Levitation\"", BT3.Spots.IK1_1109_WhiteTowerDoor, enter);
                case Scripts.ANMAWhiteTowerDoor_IK11109: return new BitDesc("Cast \"Anti-Magic\"", BT3.Spots.IK1_1109_WhiteTowerDoor, enter);
                case Scripts.PHDOWhiteTowerDoor_IK11109: return new BitDesc("Cast \"Phase Door\"", BT3.Spots.IK1_1109_WhiteTowerDoor, enter);
                case Scripts.INWOGreyTowerDoor_IK10009: return new BitDesc("Cast \"Elik's Instant Wolf\"", BT3.Spots.IK1_0009_GreyTowerDoor, enter);
                case Scripts.WIHEGreyTowerDoor_IK10009: return new BitDesc("Cast \"Wind Hero\"", BT3.Spots.IK1_0009_GreyTowerDoor, enter);
                case Scripts.FOFOGreyTowerDoor_IK10009: return new BitDesc("Cast \"Fanskar's Force Focus\"", BT3.Spots.IK1_0009_GreyTowerDoor, enter);
                case Scripts.INVIGreyTowerDoor_IK10009: return new BitDesc("Cast \"Kylearan's Invisibility Spell\"", BT3.Spots.IK1_0009_GreyTowerDoor, enter);
                case Scripts.MAFLBlackTowerDoor_IK11100: return new BitDesc("Cast MAFL/LERE/GRRE", BT3.Spots.IK1_1100_BlackTowerDoor, enter);
                case Scripts.SHSPBlackTowerDoor_IK11100: return new BitDesc("Cast \"Shock-Sphere\"", BT3.Spots.IK1_1100_BlackTowerDoor, enter);
                case Scripts.FEARBlackTowerDoor_IK11100: return new BitDesc("Cast \"Word of Fear\"", BT3.Spots.IK1_1100_BlackTowerDoor, enter);
                case Scripts.SUELBlackTowerDoor_IK11100: return new BitDesc("Cast \"Summon Elemental\"", BT3.Spots.IK1_1100_BlackTowerDoor, enter);
                case Scripts.SPBIBlackTowerDoor_IK11100: return new BitDesc("Cast \"Baylor's Spell Bind\"", BT3.Spots.IK1_1100_BlackTowerDoor, enter);
                case Scripts.GetBowChamber_SG0900: return new BitDesc("Obtain \"Valarian's Bow\"", BT3.Spots.SG_0900_Chamber, enter);
                case Scripts.GetArrowsChamber_SG0900: return new BitDesc("Obtain \"Arrows of Life\"", BT3.Spots.SG_0900_Chamber, enter);
                case Scripts.UseHeartValarian_SG0403: return new BitDesc("Use \"Tslotha's Heart\"", BT3.Spots.SG_0403_Valarian, enter);
                case Scripts.UseWaterValarian_SG0403: return new BitDesc("Use container with \"Water of Life\"", BT3.Spots.SG_0403_Valarian, enter);
                ...
                case Scripts.TalkHawkslayer_A1011: return new BitDesc("Talk to Hawkslayer", BT3.Spots.A_1011_Hawkslayer, enter);
                case Scripts.DefeatDragon_M20500: return new BitDesc("Defeat \"Rainbow Dragon\"", BT3.Spots.M2_0500_DragonBlood, enter);
                case Scripts.GetCrystalKey_M20500: return new BitDesc("Obtain \"Crystal Key\"", BT3.Spots.M2_0500_DragonBlood, enter);
                case Scripts.FLANCyanis_CT30302: return new BitDesc("Cast FLAN/REST/HEAL", BT3.Spots.CT3_0302_Cyanis, enter).AddChecked(enter, BT3.Spots.CT3_0005_Figures);
                case Scripts.DefeatCyanis_CT30302: return new BitDesc("Defeat \"Cyanis\"", BT3.Spots.CT3_0302_Cyanis, enter).AddChecked(enter, BT3.Spots.CT3_0005_Figures);
                case Scripts.GetTriangle_CT30302: return new BitDesc("Obtain \"Magic Triangle\"", BT3.Spots.CT3_0302_Cyanis, enter);
                case Scripts.UseDragonBlood_L0608: return new BitDesc("Use container with \"Dragon Blood\"", BT3.Spots.L_0608_RainbowRose, enter).AddClear("Pick \"Rainbow Rose\"", BT3.Spots.L_0608_RainbowRose);
                case Scripts.GiveWhiteRose_AT20500: return new BitDesc("Give \"White Rose\" to Shade", BT3.Spots.AT2_0400_WhiteRose, enter).AddChecked(enter, BT3.Spots.AT2_0500_Teleport);
                case Scripts.GiveBlueRose_AT20004: return new BitDesc("Give \"Blue Rose\" to Shade", BT3.Spots.AT2_0005_BlueRose, enter, BT3.Spots.AT2_0004_Teleport);
                case Scripts.GiveRedRose_AT20508: return new BitDesc("Give \"Red Rose\" to Shade", BT3.Spots.AT2_0608_RedRose, enter,  BT3.Spots.AT2_0508_Teleport);
                case Scripts.GiveYellowRose_AT21100: return new BitDesc("Give \"Yellow Rose\" to Shade", BT3.Spots.AT2_1000_YellowRose, enter).AddChecked(enter, BT3.Spots.AT2_1100_Teleport);
                case Scripts.GiveRainbowRose_AT21005: return new BitDesc("Give \"Rainbow Rose\" to Shade", BT3.Spots.AT2_1004_RainbowRose, enter).AddChecked(enter, BT3.Spots.AT2_1005_Teleport);
                case Scripts.GetCrown_AT20905: return new BitDesc("Obtain \"Crown of Truth\"", BT3.Spots.AT2_0905_Alliria, enter);
                case Scripts.GetBelt_AT20905: return new BitDesc("Obtain \"Belt of Alliria\"", BT3.Spots.AT2_0905_Alliria, enter);
                case Scripts.UseTriangle_AT10615: return new BitDesc("Use \"Magic Triangle\"", BT3.Spots.AT1_0615_Crystal, enter);
                case Scripts.GetStrifespear_M11002: return new BitDesc("Obtain \"Strifespear\"", BT3.Spots.M1_1002_Strifespear, enter);
                case Scripts.Hawkslayer_A1011: return new BitDesc("Recruit \"Hawkslayer\"", BT3.Spots.A_1011_Hawkslayer, enter);
                case Scripts.TalkHawkslayer_F0302: return new BitDesc("Talk to Hawkslayer", BT3.Spots.F_0302_Hawkslayer, enter);
                case Scripts.GetHawkslayer_F0302: return new BitDesc("Recruit \"Hawkslayer\"", BT3.Spots.F_0302_Hawkslayer, enter);
                case Scripts.TalkFerofist_PQ0215: return new BitDesc("Talk to dwarf", BT3.Spots.PQ_0215_Ferofist, enter);
                case Scripts.GetLeftKey_PQ0811: return new BitDesc("Obtain \"Left Key\"", BT3.Spots.PQ_0811_LeftKey, enter);
                case Scripts.GetRightKey_B1102: return new BitDesc("Obtain \"Right Key\"", BT3.Spots.B_1102_RightKey, enter);
                case Scripts.DefeatWhiteWizard_WT40400: return new BitDesc("Defeat \"White Wizard\"", BT3.Spots.WT4_0400_CrystalLens, enter);
                case Scripts.GetCrystalLens_WT40400: return new BitDesc("Obtain \"Crystal Lens\"", BT3.Spots.WT4_0400_CrystalLens, enter);
                case Scripts.DefeatGreyWizard_GT40203: return new BitDesc("Defeat \"Grey Wizard\"", BT3.Spots.GT4_0203_SmokeyLens, enter);
                case Scripts.GetSmokeyLens_GT40203: return new BitDesc("Obtain \"Smokey Lens\"", BT3.Spots.GT4_0203_SmokeyLens, enter);
                case Scripts.DefeatBlackWizard_BT40304: return new BitDesc("Defeat \"Black Wizard\"", BT3.Spots.BT4_0304_BlackLens, enter);
                case Scripts.GetBlackLens_BT40304: return new BitDesc("Obtain \"Black Lens\"", BT3.Spots.BT4_0304_BlackLens, enter);
                case Scripts.GetShadowLock_SC0307: return new BitDesc("Obtain \"Shadow Lock\"", BT3.Spots.SC_0307_ShadowLock, enter);
                case Scripts.GetShadowDoor_DC0505: return new BitDesc("Obtain \"Shadow Door\"", BT3.Spots.DC_0505_ShadowDoor, enter);
                case Scripts.UseShadowDoor_N0505: return new BitDesc("Use \"Shadow Door\"", BT3.Spots.N_0505_MagicDoor, enter);
                case Scripts.UseShadowLock_N0505: return new BitDesc("Use \"Shadow Lock\"", BT3.Spots.N_0505_MagicDoor, enter);
                case Scripts.UseRightKey_W0202: return new BitDesc("Use \"Right Key\"", BT3.Spots.W_0202_Portal, enter).AddClear("Turn \"Right Key\" other than 18 times", BT3.Spots.W_0202_Portal);
                case Scripts.UseLeftKey_W0202: return new BitDesc("Use \"Left Key\"", BT3.Spots.W_0202_Portal, enter).AddClear("Turn \"Left Key\" other than 15 times", BT3.Spots.W_0202_Portal);
                case Scripts.GetWand_ID20400: return new BitDesc("Obtain \"Wand of Power\"", BT3.Spots.ID2_0400_Lanatir, enter);
                case Scripts.GetSphere_ID20400: return new BitDesc("Obtain \"Sphere of Lanatir\"", BT3.Spots.ID2_0400_Lanatir, enter);
                ...
                case Scripts.DefeatUrmech_S0607: return new BitDesc("Defeat \"Urmech\"", BT3.Spots.S_0607_Urmech, enter);
                case Scripts.SpareUrmech_S0607: return new BitDesc("Spare Urmech ", BT3.Spots.S_0607_Urmech, enter).AddChecked(enter, BT3.Spots.S_0602_Geomancer);
                case Scripts.GetHelm_S0703: return new BitDesc("Obtain \"Ferofist's Helm\"", BT3.Spots.S_0703_Chest, enter);
                case Scripts.GetHammer_S0703: return new BitDesc("Obtain \"Hammer of Wrath\"", BT3.Spots.S_0703_Chest, enter);
                case Scripts.KillWerra_T0000: return new BitDesc("Black Slayers kill Werra", BT3.Spots.T_0000_Werra, enter).AddSet("Black Slayers kill Werra", BT3.Spots.T_0001_Shield).AddChecked(enter, BT3.Spots.T_0001_Shield);
                case Scripts.GetShield_T0001: return new BitDesc("Obtain \"Werra's Shield\"", BT3.Spots.T_0001_Shield, enter);
                case Scripts.ElderDies_SB1514: return new BitDesc("Guild elder dies", BT3.Spots.SB_ReviewBoard);
                case Scripts.UseHelm_M32102: return new BitDesc("Use \"Ferofist's Helm\"", BT3.Spots.M3_2102_Helm, enter).AddChecked(enter, BT3.Spots.M3_1107_Door);
                case Scripts.UseSphere_M20912: return new BitDesc("Use \"Sphere of Lanatir\"", BT3.Spots.M2_0912_Sphere, enter).AddChecked(enter, BT3.Spots.M3_1107_Door);
                case Scripts.UseBelt_M10316: return new BitDesc("Use \"Belt of Alliria\"", BT3.Spots.M1_0316_Belt, enter).AddChecked(enter, BT3.Spots.M3_1107_Door);
                case Scripts.UseCloak_M31520: return new BitDesc("Use \"Sceadu's Cloak\"", BT3.Spots.M3_1520_Cloak, enter).AddChecked(enter, BT3.Spots.M3_1107_Door);
                case Scripts.UseBow_M21816: return new BitDesc("Use \"Valarian's Bow\"", BT3.Spots.M2_1816_Bow, enter).AddChecked(enter, BT3.Spots.M3_1107_Door);
                case Scripts.UseShield_M31205: return new BitDesc("Use \"Werra's Shield\"", BT3.Spots.M3_1205_Shield, enter).AddChecked(enter, BT3.Spots.M3_1107_Door);
                ...
                case Scripts.UseCrystalLens_IK10509: return new BitDesc("Use \"Crystal Lens\"", BT3.Spots.IK1_0509_IceDungeonEnt, enter);
                case Scripts.UseSmokeyLens_IK10509: return new BitDesc("Use \"Smokey Lens\"", BT3.Spots.IK1_0509_IceDungeonEnt, enter);
                case Scripts.UseBlackLens_IK10509: return new BitDesc("Use \"Black Lens\"", BT3.Spots.IK1_0509_IceDungeonEnt, enter);
                case Scripts.DefeatSceadu_SD20513: return new BitDesc("Defeat \"Sceadu\"", BT3.Spots.SD2_0513_Sceadu, enter);
                case Scripts.GetCloak_SD20513: return new BitDesc("Obtain \"Sceadu's Cloak\"", BT3.Spots.SD2_0513_Sceadu, enter);
                case Scripts.GetJustice_SD20513: return new BitDesc("Obtain \"Helm of Justice\"", BT3.Spots.SD2_0513_Sceadu, enter);
    ...
    public class BT3QuestInfo : QuestInfo<BT3Quest>
    {
        ...
        public override bool QuestsEqual(QuestInfo<BT3Quest> info)
        {
        ...
        {
            if (data == null || data.ScriptBytes == null || data.ScriptBytes.Length <= iScriptIndex - data.ScriptsOffset || iScriptIndex < data.ScriptsOffset)
                return false;
            return data.ScriptBytes[iScriptIndex - data.ScriptsOffset] == bCompare;
        }
