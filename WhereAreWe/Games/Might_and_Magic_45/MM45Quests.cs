...
namespace WhereAreWe
{
    ...
    public class MM45QuestInfo : QuestInfo<MM45Quest>
    {
        ...
        public override BasicQuest[] GetQuests()
        {
            ...
            Drawkcab.AddLocations(new QuestLocation("Visit Brother Otto", MM45.Spots.MonkOtto),
                new QuestLocation("Visit Brother Pip", MM45.Spots.MonkPip),
            ...
            DefeatAlamar.AddLocations("Talk to Dragon Pharaoh", MM45.Spots.DragonPharaoh, "Confront Lord Alamar", MM45.Spots.Alamar,
                new QuestLocation("Lower the stasis field", MM45.Spots.StasisComputer),
        ...
        public override void SetQuests(QuestData data, int iOverrideCharAddress = -1)
        {
            ...
            QuestGoal corak = bits.Dark(Dark.FreeCorakEP10408);
            DefeatAlamar.AddPre(bits.Dark(Dark.DragonParaohGP40609));
            DefeatAlamar.AddObj(QuestStatus.Or(fqi.Goal(FileB.StasisComputer), corak), corak, bits.Dark(Dark.ChosenOnesGP40609),
            ...
            if (bits.Dark(Dark.OpenChestCS3026) == QuestGoal.Complete && RatQueen.Pre[0].IsComplete)
            ...
            if (bits.Dark(Dark.OpenChestCS3026) == QuestGoal.Complete && RatQueen.Post[0].IsComplete)
