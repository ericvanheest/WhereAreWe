...
{
    public class EOB2SpellList : SpellList
    {
        List<EOB2Spell> m_spells;
    ...
    public class EOB2Spell : EOBSpell
    {
        ...
        public EOB2Spell(EOBSpellIndex index, SpellType type, int level, SpellRange range, string name, SpellTarget target, SpellDuration duration, string shortDesc, string desc)
        {
            Index = index;
            Name = name;
            Type = type;
        ...
        public static EOB2Spell None
        {
            get { return new EOB2Spell(EOBSpellIndex.None, SpellType.Unknown, 0, SpellRange.Character, "None", SpellTarget.Unknown, SpellDuration.Instant, "", ""); }
        }
