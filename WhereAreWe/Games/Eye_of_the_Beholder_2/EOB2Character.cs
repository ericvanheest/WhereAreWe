...
{
    public class EOB2CharacterOffsets : EOBCharacterOffsets
    {
        public override int Class => 34;
        public override int Race => 33;
        public override int Alignment => 35;
        public override int ArmorClass => 31;
        public override int CurrentHP => 27;
        public override int MaxHP => 29;
        public override int Inventory => 221;
        public override int InventoryLength => 54;
        public override int Experience => 41;
        public override int ExperienceLength => 12;
        public override int Level => 38;
        public override int Spells => 57;
        public override int SpellsLength => 64;
        public override int LevelLength => 1;
        public override int Food => 37;
        public override int Portrait => 36;
        public override int ItemUse => 32;
        public override int SpellTimeouts => 175;
        public override int ActiveSpells => 215;
    }

    public class EOB2Stats : EOBStats
    {
        public EOB2Stats(byte[] bytes, int offset = 0)
        {
    ...
    public class EOB2Character : EOBCharacter
    {
        public const int SizeInBytes = 345;
        public const int SizeInMemory = 345;

        public EOB2Character()
        {
            m_game = GameNames.EyeOfTheBeholder2;
        }

        public TwoByteStat m_hitPoints;
        public override CharacterOffsets Offsets { get { return EOB2.Offsets; } }
        public override int CharacterSize { get { return SizeInBytes; } }
        public override EOBStats CreateStats(byte[] bytes, int offset) { return new EOB2Stats(RawBytes, Offsets.Stats); }
        ...
        public override void SetCharFromStream(int iCharIndex, Stream stream, GameInfo info, EncounterInfo encounterInfo = null, bool bFromRosterFile = false, byte[] itemTable = null)
        {
            ...
            m_hitPoints = new TwoByteStat(RawBytes, Offsets.CurrentHP, Offsets.MaxHP);
            Inventory = new EOB2Inventory(RawBytes, itemTable, Offsets.Inventory);
    ...
    public class EOB2Inventory : EOBInventory
    {
        public EOB2Inventory(byte[] bytes, byte[] bytesItemTable, int offset = 0)
        {
            ...
            for (int i = 0; i < 27; i++)
            {
                ...
                EOBItem item = EOBItem.FromInventoryBytes(GameNames.EyeOfTheBeholder2, bytes, bytesItemTable, i, offset);
                if (item != null)
                {
        ...
        public EOB2Inventory(List<Item> items)
        {
            m_items = items;
        }
        ...
        public override BasicDamage RangedWeaponDamage
        {
            get
            {
                EOB2Item itemRanged = null;
                foreach (EOB2Item item in SelectEquippedItems)
                {
