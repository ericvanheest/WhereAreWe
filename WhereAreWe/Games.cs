    ...
    public static class Games
    {
        ...
        public static string GameEnumString(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.EyeOfTheBeholder1: return "EyeOfTheBeholder1";
                case GameNames.EyeOfTheBeholder2: return "EyeOfTheBeholder2";
                case GameNames.EyeOfTheBeholder3: return "EyeOfTheBeholder3";
        ...
        public static GameNames GameEnum(string str)
        {
            switch (str)
            {
                ...
                case "EyeOfTheBeholder1": return GameNames.EyeOfTheBeholder1;
                case "EyeOfTheBeholder2": return GameNames.EyeOfTheBeholder2;
                case "EyeOfTheBeholder3": return GameNames.EyeOfTheBeholder3;
        ...
        public static GameNames GameEnumFromShort(string str)
        {
            switch(str.ToLower())
            {
                ...
                case "eob1": return GameNames.EyeOfTheBeholder1;
                case "eob2": return GameNames.EyeOfTheBeholder2;
                case "eob3": return GameNames.EyeOfTheBeholder3;
        ...
        public static MemoryHacker CreateHacker(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.Ultima1: return new Ultima1MemoryHacker();
                case GameNames.EyeOfTheBeholder1: return new EOB1MemoryHacker();
                case GameNames.EyeOfTheBeholder2: return new EOB2MemoryHacker();
                default: return null;
            }
        }
        ...
        public static byte[] InternalMapBytes(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.Ultima1: return Global.DecompressBytes(Properties.Resources.Ultima_1_waw);
                case GameNames.EyeOfTheBeholder1: return Global.DecompressBytes(Properties.Resources.Eye_of_the_Beholder_1_waw);
                case GameNames.EyeOfTheBeholder2: return Global.DecompressBytes(Properties.Resources.Eye_of_the_Beholder_2_waw);
        ...
        public static Race[] Races(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.EyeOfTheBeholder2:
                    return new Race[] { new Race(GenericRace.None), new Race(GenericRace.Human), new Race(GenericRace.Elf), new Race(GenericRace.HalfElf),
                        new Race(GenericRace.Dwarf), new Race(GenericRace.Gnome), new Race(GenericRace.Halfling) };
                case GameNames.Ultima1:
                    return new Race[] { new Race(GenericRace.None), new Race(GenericRace.Human), new Race(GenericRace.Elf), new Race(GenericRace.Dwarf),
                        new Race(GenericRace.Bobbit) };
        ...
        public static string GetInternalMap(string strInternalFile)
        {
            ...
            switch (strInternalFile)
            {
                ...
                case "Eye_of_the_Beholder_1": return utf8.GetString(InternalMapBytes(GameNames.EyeOfTheBeholder1));
                case "Eye_of_the_Beholder_2": return utf8.GetString(InternalMapBytes(GameNames.EyeOfTheBeholder2));
                case "Ultima_1": return utf8.GetString(InternalMapBytes(GameNames.Ultima1));
        ...
        public static string DefaultTitle(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.EyeOfTheBeholder1: return "   START1?$|   START1? ";
                case GameNames.EyeOfTheBeholder2: return "   EOB2$|   EOB2 ";
                case GameNames.Ultima1: return "   ULTIMA$|   ULTIMA ";
        ...
        public static bool IsEyeOfTheBeholder(GameNames game) { return EOBGames.Contains(game); }
        public static bool IsUltima(GameNames game) { return UltimaGames.Contains(game); }

        public static GameNames[] ImplementedGames
        {
            get
            {
                // This is the order in which games will appear in the "Currently Playing Game" dropdown
                return new GameNames[]
                {
                    ...
                    GameNames.EyeOfTheBeholder1,
                    GameNames.EyeOfTheBeholder2,
        ...
        public static IEnumerable<Monster> GetMonsters(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.Ultima1: return Ultima1.Monsters;
                case GameNames.Wizardry1:
                case GameNames.Wizardry2:
                case GameNames.Wizardry3:
                case GameNames.Wizardry4:
                case GameNames.Wizardry5: return Games.GetWizGlobals(game).GetMonsters();
                case GameNames.EyeOfTheBeholder1: return EOB1.Monsters;
                case GameNames.EyeOfTheBeholder2: return EOB2.Monsters;
                default: return null;
            }
        }
        ...
        public static string GetItemName(GameNames game, int index)
        {
            ...
            switch (game)
            {
                ...
                case GameNames.Ultima1: return UltimaItem.GetName((UltimaItemIndex)index);
                case GameNames.Wizardry1:
                case GameNames.Wizardry2:
                case GameNames.Wizardry3:
                case GameNames.Wizardry4:
                ...
                case GameNames.EyeOfTheBeholder1:
                case GameNames.EyeOfTheBeholder2:
                    List<EOBItem> eobItems = Games.GetEOBGlobals(game).GetItems();
                    if (index < eobItems.Count)
                        return eobItems[index].Name;
                    return strUnknown;
        ...
        public static string GetMonsterName(GameNames game, int index)
        {
            ...
            switch (game)
            {
                ...
                case GameNames.EyeOfTheBeholder1:
                case GameNames.EyeOfTheBeholder2:
                    List<EOBMonster> eobMonsters = Games.GetEOBGlobals(game).GetMonsters();
                    if (index < eobMonsters.Count)
                        return eobMonsters[index].Name;
                    return strUnknown;
        ...
        public static EOBGameGlobals GetEOBGlobals(GameNames game)
        {
            switch (game)
            {
                case GameNames.EyeOfTheBeholder1: return Global.EOB1 as EOBGameGlobals;
                case GameNames.EyeOfTheBeholder2: return Global.EOB2 as EOBGameGlobals;
                default: return null;
            }
        }

        public static UltimaGameGlobals GetUltimaGlobals(GameNames game)
        {
            switch (game)
            {
                case GameNames.Ultima1: return Global.Ultima1 as UltimaGameGlobals;
                default: return null;
            }
        }
        ...
        public static GameGlobals GetGlobals(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.Ultima1: return Global.Ultima1 as GameGlobals;
                ...
                case GameNames.EyeOfTheBeholder1: return Global.EOB1 as GameGlobals;
                case GameNames.EyeOfTheBeholder2: return Global.EOB2 as GameGlobals;
                default: return null;
            }
        }
        ...
        public static Spell GetSpell(GameNames game, int index)
        {
            switch (game)
            {
                ...
                case GameNames.EyeOfTheBeholder1: return EOB1.Spells[index];
                case GameNames.EyeOfTheBeholder2: return EOB2.Spells[index];
                case GameNames.Ultima1: return Ultima1.Spells[index];
                default: return null;
            }
        }
        ...
        public static int GetSpellCount(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.EyeOfTheBeholder1: return EOB1.Spells.Count;
                case GameNames.EyeOfTheBeholder2: return EOB2.Spells.Count;
                case GameNames.Ultima1: return Ultima1.Spells.Count;
                default: return 0;
            }
        }

        public static string[] GetRegistries(GameNames game)
        {
            switch (game)
            {
                case GameNames.MightAndMagic1: return new string[] { "GOGMM1", "Games\\1207661203" };
                case GameNames.MightAndMagic2: return new string[] { "GOGMM2", "Games\\1207661213" };
                case GameNames.MightAndMagic3: return new string[] { "GOGMM3", "Games\\1207661223" };
                case GameNames.MightAndMagic45: return new string[] { "GOGMM45", "Games\\1207661233" };
                // The Wizardry and Bard's Tale games don't have a proper installer, so there are no registry keys
                case GameNames.EyeOfTheBeholder1: return new string[] { "Games\\1432575012" };
                case GameNames.EyeOfTheBeholder2: return new string[] { "Games\\1432576039" };
                case GameNames.EyeOfTheBeholder3: return new string[] { "Games\\1432576327" };
                case GameNames.Ultima1: return new string[] { "Games\\1207662593" };
                case GameNames.Ultima2: return new string[] { "Games\\1207662603" };
                default: return new string[] { String.Empty };
            }
        }
        ...
        public static string GetDefaultLink(GameNames game)
        {
            switch(game)
            {
                ...
                case GameNames.EyeOfTheBeholder1: return "Launch Eye of the Beholder.lnk";
                case GameNames.EyeOfTheBeholder2: return "Launch Eye of the Beholder II - The Legend of Dakrmoon.lnk";      // "Darkmoon" is actually misspelled in the GOG shortcut...
                case GameNames.EyeOfTheBeholder3: return "Launch Eye of the Beholder III - Assault on Myth Drannor.lnk";
                case GameNames.Ultima1: return "Launch Ultima.lnk";
                case GameNames.Ultima2: return "Launch Ultima II - The Revenge of the Enchantress";
        ...
        public static BasicInfoStyle GetInfoType(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.Ultima1: return BasicInfoStyle.NoLevel;
        ...
        public static int MaxNameLength(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.EyeOfTheBeholder1:
                case GameNames.EyeOfTheBeholder2: return 10;
                default: return 15;
            }
        }
        ...
        public static GenericClass[] Classes(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.Ultima1:
                    return new GenericClass[] { GenericClass.Fighter, GenericClass.Cleric, GenericClass.Wizard, GenericClass.Thief };
                case GameNames.EyeOfTheBeholder1:
                case GameNames.EyeOfTheBeholder2:
                    return EOBBaseCharacter.EOBClasses;
        ...
        public static GenericAlignmentValue[] Alignments(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.EyeOfTheBeholder1:
                case GameNames.EyeOfTheBeholder2: return new GenericAlignmentValue[] {
                    GenericAlignmentValue.LawfulGood,
                    GenericAlignmentValue.LawfulNeutral,
                    GenericAlignmentValue.LawfulEvil,
                    GenericAlignmentValue.NeutralGood,
                    GenericAlignmentValue.TrueNeutral,
                    GenericAlignmentValue.NeutralEvil,
                    GenericAlignmentValue.ChaoticGood,
                    GenericAlignmentValue.ChaoticNeutral,
                    GenericAlignmentValue.ChaoticEvil
                };
        ...
        public static int ClassValue(GameNames game, GenericClass gc)
        {
            switch (game)
            {
                ...
                case GameNames.Ultima1: return (int)UltimaCharacter.ClassForGeneric(gc);
                case GameNames.EyeOfTheBeholder1: return (int)EOBCharacter.ClassForGeneric(gc);
                default: return 0;
            }
        }
        ...
        public static string Name(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.EyeOfTheBeholder1: return "Eye of the Beholder 1";
                case GameNames.EyeOfTheBeholder2: return "Eye of the Beholder 2: The Legend of Darkmoon";
                case GameNames.EyeOfTheBeholder3: return "Eye of the Beholder 3: Assault on Myth Drannor";
        ...
        public static string ShortName(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.EyeOfTheBeholder1: return "Eye of the Beholder 1";
                case GameNames.EyeOfTheBeholder2: return "Eye of the Beholder 2";
                case GameNames.EyeOfTheBeholder3: return "Eye of the Beholder 3";
                case GameNames.DOSBox: return "DOSBox";
                default: return "";
            }
        }
        ...
        public static string MapForGame(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.EyeOfTheBeholder1: return ":Eye_of_the_Beholder_1";
                case GameNames.EyeOfTheBeholder2: return ":Eye_of_the_Beholder_2";
                case GameNames.EyeOfTheBeholder3: return ":Eye_of_the_Beholder_3";
                default: return "";
            }
        }
        ...
        public static MapTitlePairFunction GetMapTitleFunction(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.Ultima1: return Ultima1MemoryHacker.GetMapTitlePair;
                case GameNames.EyeOfTheBeholder1: return EOB1MemoryHacker.GetMapTitlePair;
                case GameNames.EyeOfTheBeholder2: return EOB2MemoryHacker.GetMapTitlePair;
        ...
        public static GameNames[] EOBGames { get { return new GameNames[] { GameNames.EyeOfTheBeholder1, GameNames.EyeOfTheBeholder2, GameNames.EyeOfTheBeholder3 }; } }
        public static GameNames[] UltimaGames { get { return new GameNames[] { GameNames.Ultima1, GameNames.Ultima2, GameNames.Ultima3 }; } }
        ...
        public static GameNames WhichGame(object o)
        {
            if (o is BasicQuestType)
            {
                ...
                if (o is EOB1Quest) return GameNames.EyeOfTheBeholder1;
            }
            else if (o is Item)
            {
                ...
                if (o is EOB1Item) return GameNames.EyeOfTheBeholder1;
            }
            ...
            else if (o is EOB1Map) return GameNames.EyeOfTheBeholder1;
            else if (o is EOB2Map) return GameNames.EyeOfTheBeholder2;
        ...
        public static bool IsSightBlocking(GameNames game, MapSheet sheet, MapLineInfo grid, MapLineInfo line, List<MapIcon> icons = null, Direction dir = Direction.None, bool bForward = true)
        {
            ...
            else if (icons != null && icons.Count > 0)
            {
                switch (game)
                {
                    ...
                    case GameNames.MightAndMagic45:
                    case GameNames.MightAndMagic5:
                        if (icons.Any(i => i.Name == IconName.DoorHalf && i.Orientation == dir))
                            return true;   // Can not see through closed doors in this game
                        break;
                    case GameNames.EyeOfTheBeholder1:
                    case GameNames.EyeOfTheBeholder2:
                        if (bForward && icons.Any(i => i.Name == IconName.LockedFull))
                            return true;   // Can not see through closed doors in this game
                        break;
                    default:
                        break;
            ...
            return !line.Equals(grid);    // Any other arbitrary line -> assume sight-blocking
        }
        ...
        public static int CharacterSize(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.Ultima1: return Ultima1Character.SizeInBytes;
                case GameNames.Wizardry1:
                case GameNames.Wizardry2:
                case GameNames.Wizardry3:
                ...
                case GameNames.EyeOfTheBeholder1: return EOB1Character.SizeInBytes;
                case GameNames.EyeOfTheBeholder2: return EOB2Character.SizeInBytes;
                default: return 0;
            }
        }
        ...
        public static CharacterOffsets GetCharacterOffsets(GameNames game)
        {
            switch (game)
            {
                ...
                case GameNames.Ultima1: return Ultima1.Offsets;
                case GameNames.Wizardry1:
                case GameNames.Wizardry2:
                ...
                case GameNames.EyeOfTheBeholder1: return EOB1.Offsets;
                case GameNames.EyeOfTheBeholder2: return EOB2.Offsets;
                default: return null;
            }
        }
        ...
        public static int CharacterMemorySize(GameNames game)
        {
            switch (game)
            {
                case GameNames.Ultima1: return Ultima1Character.SizeInMemory;
                ...
                case GameNames.EyeOfTheBeholder1: return EOB1Character.SizeInMemory;
                case GameNames.EyeOfTheBeholder2: return EOB2Character.SizeInMemory;
        ...
        public static CharacterInfoControl CreateCharacterInfoControl(GameNames game, IMain main)
        {
            switch (game)
            {
                ...
                case GameNames.Ultima1: return new Ultima123CharacterInfoControl(main);
                case GameNames.Wizardry1:
                case GameNames.Wizardry2:
                case GameNames.Wizardry3:
                ...
                case GameNames.EyeOfTheBeholder1:
                case GameNames.EyeOfTheBeholder2: return new EOB123CharacterInfoControl(main);
                default: return null;
            }
        }
        ...
        public static bool RealtimeCombat(GameNames game)
        {
            switch (game)
            {
                case GameNames.MightAndMagic3:
    ...
    public class Race
    {
        ...
        public static string RaceString(GenericRace race)
        {
            switch (race)
            {
                ...
                case GenericRace.Halfling: return "Halfling";
                case GenericRace.Bobbit: return "Bobbit";
