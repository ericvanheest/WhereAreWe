...
namespace WhereAreWe
{
    public partial class SpellReferenceForm : HackerBasedForm
    {
        ...
        private void SpellListView_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            spellListFavorites.SpellListView.ListViewItemSorter = new SpellReferenceComparer(spellListFavorites.SpellListView, e.Column, m_bAscendingFavSort);
        ...
        public bool SetSpellInfo(SpellInfo spellInfo, bool bFavoritesOnly = false)
        {
            ...
            else if (spellInfo is EOBSpellInfo)
            {
                EOBSpellInfo info = spellInfo as EOBSpellInfo;

                iActingChar = info.Game.ActingCaster;

                if (info.Party != null && info.Party.Bytes.Length >= iActingChar * info.Party.CharacterSize)
                    character = EOBCharacter.Create(info.Game.Game, null, -1, info.Party.Bytes, iActingChar * info.Party.CharacterSize);
            }
        ...
        private void cmSpell_Opening(object sender, CancelEventArgs e)
        {
            ...
            miCtxFavorites.Visible = bSelected && m_character != null;
    ...
    class SpellReferenceComparer : BasicListViewComparer
    {
        public SpellReferenceComparer(ListView lv, int column, bool bAscending) : base(lv, column, bAscending) { }
        ...
        public override int Compare(object x, object y)
        {
            ...
            switch (m_column)
            {
                ...
                case 3: return Order(Math.Sign(spell1.Spell.Cost.SpellPoints - spell2.Spell.Cost.SpellPoints));
    ...
    public class SpellTag
    {
        ...
        public SpellTag(Spell spell, bool bCastable, int iSelected, int iMemorized)
        {
            Spell = spell;
            Castable = bCastable;
            Selected = iSelected;
    ...
    public enum SpellTarget
    {
        ...
        TwoSquares = 58,
        ThreeSquares = 59,
        ThreeSquaresCross = 60,
        OneMonsterPerLevel = 61,
        Unknown = 255
    }
    ...
    public class Spell
    {
        ...
        public SpellRange Range = SpellRange.Character;
        ...
        public static string GetDurationString(SpellDuration duration)
        {
            switch (duration)
            {
                ...
                case SpellDuration.Special: return "Special";
                case SpellDuration.Permanent: return "Permanent";
        ...
        public string TargetString
        {
            get
            {
                switch (Target)
                {
                    ...
                    case SpellTarget.Inventory: return "Character Inventory";
                    case SpellTarget.OneSquare: return "One Square";
                    case SpellTarget.TwoSquares: return "Two Squares";
                    case SpellTarget.ThreeSquares: return "Three Squares";
                    case SpellTarget.ThreeSquaresCross: return "Three Cross Squares";
                    case SpellTarget.OneMonsterPerLevel: return "Monster Per Level";
                    case SpellTarget.Special: return "Special";
                    default: return "Unknown";
                }
            }
        }
        ...
        public override bool Equals(object obj)
        {
            if (!(obj is Spell))
                return false;
            return BasicIndex == ((Spell)obj).BasicIndex;
        }
