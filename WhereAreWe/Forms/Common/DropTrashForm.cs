...
namespace WhereAreWe
{
    public partial class DropTrashForm : CommonKeyForm
    {
        ...
        private void lvDiscarded_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            lvDiscarded.ListViewItemSorter = new DropItemComparer(lvDiscarded, e.Column, m_bAscendingSort);
            lvDiscarded.Sort();
        }
    ...
    class DropItemComparer : BasicListViewComparer
    {
        public DropItemComparer(ListView lv, int column, bool bAscending) : base(lv, column, bAscending) { }
        ...
        public override int Compare(object x, object y)
        {
            ...
            switch (m_column)
            {
                case 0: return Order(String.Compare(lvi1.Text, lvi2.Text));
                case 1: return Order(String.Compare(lvi1.SubItems[1].Text, lvi2.SubItems[1].Text));
                case 2: return Order(Math.Sign((lvi1.Tag as Item).Value - (lvi2.Tag as Item).Value));
