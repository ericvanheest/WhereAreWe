...
namespace WhereAreWe
{
    public partial class SearchForm : HackerBasedForm
    {
        ...
        public SearchForm()
        {
            ...
            tbNoteText.ContextMenuStrip = new RichTextBoxContextMenu(tbNoteText);
        }
        ...
        private void UpdateUI(MapNote noteInitial, bool bEdit)
        {
            ...
            foreach (MapSheet sheet in m_book.Sheets)
            {
                ...
                foreach (MapNote note in notes)
                {
                    ...
                    lvi.SubItems.Add(Global.FormatForSingleLine(note.Text));
        ...
        public void UpdateLVI(ListViewItem lvi)
        {
            ...
            lvi.SubItems[4].Text = Global.FormatForSingleLine(note.Text);
        }
        ...
        private void lvNotes_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            lvNotes.ListViewItemSorter = new NoteSearchItemComparer(lvNotes, e.Column, m_bAscendingSort);
            lvNotes.Sort();
        }
    ...
    class NoteSearchItemComparer : BasicListViewComparer
    {
        public NoteSearchItemComparer(ListView lv, int column, bool bAscending) : base(lv, column, bAscending) { }
        ...
        public override int Compare(object x, object y)
        {
            ...
            switch (m_column)
            {
                case 0: return Order(Math.Sign(item1.Sheet.GameMapIndex - item2.Sheet.GameMapIndex));
                case 1: return Order(String.Compare(item1.Sheet.Title, item2.Sheet.Title));
                case 2: return Order(String.Compare(Global.PointString(item1.Note.Location), Global.PointString(item2.Note.Location)));
                case 3: return Order(String.Compare(item1.Note.Symbol, item2.Note.Symbol));
                case 4: return Order(String.Compare(item1.Note.Text, item2.Note.Text));
