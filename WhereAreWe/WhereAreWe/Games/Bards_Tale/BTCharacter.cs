...
namespace WhereAreWe
{
    ...
    public class BTInventory : Inventory
    {
        ...
        public virtual void SetBytes(byte[] bytes, int offset, GenericClass gc = GenericClass.None)
        {
        ...
        public virtual byte[] GetBytes(GenericClass gc = GenericClass.None)
        {
    ...
    public abstract class BTCharacter : BTBaseCharacter
    {
        ...
        public override int BasicSP { get { return SpellPoints.Temporary; } }
        public override int BasicMaxSP { get { return SpellPoints.Permanent; } }
        ...
        public override int BasicThievery { get { return Disarm; } }
        ...
        public override int BasicHide { get { return HideChance; } }
        public override int BasicAttacks { get { return NumAttacks; } }
        public override int BasicWon { get { return BattlesWon; } }
        public override int BasicSongs { get { return Songs; } }
        ...
        public static int[] XPBTSorcerer = new int[] { 7000, 15000, 25000, 40000, 60000, 80000, 100000, 130000, 170000, 220000, 300000, 400000, 800000 };
        ...
        public static int[] XPBT3MonkConjurerMagician = new int[] { 1800, 4000, 6000, 10000, 14000, 19000, 29000, 50000, 90000, 120000, 170000, 230000, 630000 };
        public static int[] XPBT3Wizard = new int[] { 20000, 50000, 80000, 120000, 160000, 200000, 250000, 300000, 400000, 600000, 900000, 1300000, 1700000 };
        public static int[] XPBT3Archmage = new int[] { 70000, 140000, 240000, 340000, 540000, 740000, 1000000, 1400000, 1800000, 2200000, 2600000, 3000000, 3400000 };
        public static int[] XPBT3Other = new int[] { 2000, 4000, 7000, 10000, 15000, 20000, 30000, 50000, 80000, 110000, 150000, 200000, 600000 };
        public static int[] XPBT3Geomancer = new int[] { 100000, 225000, 400000, 650000, 950000, 1400000, 1800000, 2200000, 2600000, 3000000, 3400000, 3800000, 4200000, 4600000 };
        ...
        public static long XPForLevel(GameNames game, GenericClass btClass, int iLevel)
        {
            ...
            bool bBT2 = (game == GameNames.BardsTale2);
            bool bBT3 = (game == GameNames.BardsTale3);
            int[] increase = bBT3 ? XPBT3Other : XPOther;
            ...
            switch (btClass)
            {
                ...
                case GenericClass.Magician:
                    iStart = 1800;
                    increase = bBT1 ? XPBT1MonkConjurerMagician : bBT2 ? XPBT2MonkConjurerMagician : XPBT3MonkConjurerMagician;
                    break;
                case GenericClass.Sorcerer:
                    iStart = 7000;
                    increase = bBT2 ? XPBT2Sorcerer : XPBTSorcerer;
                    break;
                case GenericClass.Wizard:
                    iStart = 20000;
                    increase = bBT1 ? XPBT1Wizard : bBT3 ? XPBT3Wizard : XPBT2Wizard;
                    break;
                case GenericClass.Archmage:
                case GenericClass.Chronomancer:
                    iStart = bBT3 ? 70000 : 100000;
                    increase = bBT3 ? XPBT3Archmage : XPArchmage;
                    break;
                case GenericClass.Geomancer:
                    iStart = 100000;
                    increase = XPBT3Geomancer;
                    break;
                default:
                    break;
            }
