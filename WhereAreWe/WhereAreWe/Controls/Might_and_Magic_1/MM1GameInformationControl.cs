...
{
    public partial class MM1GameInformationControl
        : GameInformationControl
    {
        private IMain m_main = null;
        private MM1GameInfo m_lastInfo = null;

        public MM1GameInformationControl()
        {
            InitializeComponent();
        }

        public MM1GameInformationControl(IMain main)
        {
            InitializeComponent();
            SetMain(main);
        }
