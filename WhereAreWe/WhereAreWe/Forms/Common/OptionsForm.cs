...
using static WhereAreWe.SquareStyleList;
...
namespace WhereAreWe
{
    public partial class OptionsForm : HackerBasedForm, IKeyboardHookCallback
    {
        ...
        private void UpdateUI()
        {
            ...
            if (comboCurrentGame.Items.Count < Games.ImplementedGames.Length + 1)
            {
                comboCurrentGame.Items.Clear();
                comboCurrentGame.Items.Add(new CurrentGameName(GameNames.None));
        ...
        private void lvInput_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            lvInput.ListViewItemSorter = new InputOptionItemComparer(e.Column, m_bAscendingSort);
            lvInput.Sort();
        }
    ...
    class InputOptionItemComparer : IComparer
    {
        private int m_column;
        private bool m_bAscending;

        public InputOptionItemComparer()
        {
            m_column = 0;
            m_bAscending = true;
        }
        public InputOptionItemComparer(int column, bool bAscending)
        {
            m_column = column;
        ...
        public int Compare(object x, object y)
        {
            ...
            string str1 = (lvi1 == null || m_column >= lvi1.SubItems.Count) ? String.Empty : lvi1.SubItems[m_column].Text;
            string str2 = (lvi2 == null || m_column >= lvi2.SubItems.Count) ? String.Empty : lvi2.SubItems[m_column].Text;
