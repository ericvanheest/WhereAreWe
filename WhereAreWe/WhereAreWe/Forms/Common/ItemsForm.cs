...
namespace WhereAreWe
{
    public partial class ItemsForm : HackerBasedForm
    {
        ...
        private string GetColumnText(Item item, int iColumn)
        {
            switch (iColumn)
            {
                ...
                case 5: return item.ArmorClass == 0 ? String.Empty : item.ArmorClass.ToString();
        ...
        private void lvItems_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            lvItems.ListViewItemSorter = new ItemComparer(e.Column, m_bAscendingSort);
            lvItems.Sort();
        }
    ...
    class ItemComparer : IComparer
    {
        ...
        public ItemComparer(int column, bool bAscending)
        {
            m_column = column;
        ...
        public int Compare(object x, object y)
        {
            ...
            {
                case 0:
                    returnVal = String.Compare(item1.TypeString, item2.TypeString);
                    if (returnVal == 0)
                        returnVal = Math.Sign(item1.Index - item2.Index);
                    break;
                case 1:
                    returnVal = Math.Sign(item1.Index - item2.Index);
                    break;
                case 2:
                    returnVal = String.Compare(item1.Name, item2.Name);
                    break;
                case 3:
                    returnVal = String.Compare(item1.UsableString, item2.UsableString);
                    break;
                case 4:
                    returnVal = String.Compare(item1.UsableByAlignment, item2.UsableByAlignment);
                    break;
                case 5:
                    returnVal = Math.Sign(item1.ArmorClass - item2.ArmorClass);
                    break;
                case 6:
                    returnVal = Math.Sign(item1.BaseDamage.Average - item2.BaseDamage.Average);
                    break;
                case 7:
                    returnVal = String.Compare(item1.AttributeString, item2.AttributeString);
                    break;
                case 8:
                    if (item1.EquipBonusValue != item2.EquipBonusValue)
                        returnVal = Math.Sign(item1.EquipBonusValue - item2.EquipBonusValue);
                    else
                        returnVal = String.Compare(item1.EquipEffects, item2.EquipEffects);
                    break;
                case 9:
                    returnVal = String.Compare(item1.UseEffectString, item2.UseEffectString);
                    break;
                case 10:
                    returnVal = String.Compare(item1.MaterialString, item2.MaterialString);
                    break;
                case 11:
                    returnVal = String.Compare(item1.ElementString, item2.ElementString);
                    break;
                case 12:
                    returnVal = String.Compare(item1.ResistString, item2.ResistString);
                    break;
                case 13:
                    returnVal = Math.Sign(item1.Value - item2.Value);
                    break;
                case 14:
                    returnVal = String.Compare(item1.RangeString, item2.RangeString);
                    break;
                default:
                    break;
            }
