...
namespace WhereAreWe
{
    public partial class QuestsForm : HackerBasedForm
    {
        ...
        private QuestInfo m_lastInfo = null;
        ...
        private void timerUpdateMemory_Tick(object sender, EventArgs e)
        {
            ...
            QuestInfo info = Hacker.GetQuestInfo(m_lastInfo, m_main.GetSelectedCharacterAddress(), m_bAutoAskFiles);
        ...
        private void UpdateUI(QuestInfo info)
        {
    ...
    class QuestComparer : IComparer
    {
        ...
        public QuestComparer(int column, bool bAscending)
        {
            m_column = column;
        ...
        public int Compare(object x, object y)
        {
            ...
            {
                case 0:
                    returnVal = String.Compare(quest1.Name, quest2.Name);
                    break;
                case 1:
                    returnVal = String.Compare(quest1.QuestTypeString, quest2.QuestTypeString);
                    break;
                case 2:
                    returnVal = String.Compare(quest1.StateString, quest2.StateString);
                    break;
                case 3:
                    returnVal = String.Compare(quest1.Giver, quest2.Giver);
                    break;
                case 4:
                    returnVal = String.Compare(quest1.Reward, quest2.Reward);
                    break;
            }
