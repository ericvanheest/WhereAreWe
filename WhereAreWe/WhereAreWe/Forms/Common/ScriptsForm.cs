...
namespace WhereAreWe
{
    public partial class ScriptsForm : HackerBasedForm
    {
        ...
        private void lvScripts_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            lvScripts.ListViewItemSorter = new ScriptComparer(e.Column, m_bAscendingSort);
            lvScripts.Sort();
        ...
        private void cmSelectedScript_Opening(object sender, CancelEventArgs e)
        {
            ...
            miScriptsSetBeacon.Visible = Global.Cheats;
    ...
    class ScriptComparer : IComparer
    {
        ...
        public ScriptComparer(int column, bool bAscending)
        {
            m_column = column;
        ...
        public int Compare(object x, object y)
        {
            ...
            GameScript script1 = lvi1.Tag as GameScript;
            GameScript script2 = lvi2.Tag as GameScript;

            switch (m_column)
            {
                case 0:
                    returnVal = Math.Sign((int)script1.Index - (int)script2.Index);
                    break;
                case 1:
                    returnVal = String.Compare(Global.PointString(script1.Location), Global.PointString(script2.Location));
                    break;
                case 2:
                    returnVal = Math.Sign((int)script1.Facing - (int)script2.Facing);
                    break;
                case 3:
                    returnVal = String.Compare(lvi1.SubItems[3].Text, lvi2.SubItems[3].Text);
                    break;
                case 4:
                    returnVal = Math.Sign(script1.Lines.Count - script2.Lines.Count);
                    break;
                case 5:
                    returnVal = Math.Sign(script1.NumBytes - script2.NumBytes);
                    break;
                case 6:
                    returnVal = String.Compare(lvi1.SubItems[6].Text, lvi2.SubItems[6].Text);
                    break;
            }
