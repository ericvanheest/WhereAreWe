...
namespace WhereAreWe
{
    public partial class ViewPartyForm : HackerBasedForm
    {
        ...
        public void UpdateTitle()
        {
            ...
            if (Hacker != null)
            {
                string strTime = Hacker.GetGameTime(true);
        ...
        public bool SetPartyInfo(PartyInfo info, GameInfo gameInfo, GameState gameState)
        {
            ...
            if (m_charControls[0] == null || gameInfo.Game != m_charControls[0].Character.Game)
            {
        ...
        {
            for (int i = 0; i < m_charControls.Length; i++)
                if (m_charControls[i].CharacterAddress == iCharAddress)
                    return SetCharacter(i);
            return false;
        }
        ...
        public void UpdateQuickRef()
        {
            ...
            for (int i = 0; i < m_numChars; i++)
            {
                ...
                if (lvQuickRef.Columns.Contains(chGems) && character.PartyGems)
