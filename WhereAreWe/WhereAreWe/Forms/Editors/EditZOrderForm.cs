...
namespace WhereAreWe
{
    public partial class EditZOrderForm : HackerBasedForm
    {
        ...
        private void lvZOrder_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            lvZOrder.ListViewItemSorter = new ZOrderComparer(e.Column, m_bAscendingSort);
            lvZOrder.Sort();
        }
    ...
    class ZOrderComparer : IComparer
    {
        ...
        public ZOrderComparer(int column, bool bAscending)
        {
            m_column = column;
        ...
        public int Compare(object x, object y)
        {
            ...
            try
            {
                ...
                ZOrderInfo info1 = lvi1.Tag as ZOrderInfo;
                ZOrderInfo info2 = lvi2.Tag as ZOrderInfo;

                switch (m_column)
                {
                    case 0: returnVal = String.Compare(info1.Name, info2.Name); break;
                    default: break;
                }
