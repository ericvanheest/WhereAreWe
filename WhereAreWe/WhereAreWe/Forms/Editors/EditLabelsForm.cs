...
namespace WhereAreWe
{
    public partial class EditLabelsForm : HackerBasedForm
    {
        ...
        private void lvLabels_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            lvLabels.ListViewItemSorter = new MapLabelsItemComparer(e.Column, m_bAscendingSort);
            lvLabels.Sort();
        }
    ...
    class MapLabelsItemComparer : IComparer
    {
        private int m_column;
        private bool m_bAscending;

        public MapLabelsItemComparer()
        {
            m_column = 0;
            m_bAscending = true;
        }

        public MapLabelsItemComparer(int column, bool bAscending)
        {
            m_column = column;
        ...
        public int Compare(object x, object y)
        {
            ...
            switch (m_column)
            {
                case 0:
                    ...
                    break;
                default:
                    returnVal = Math.Sign(CompareLabels(lvi1.Tag as MapLabel, lvi2.Tag as MapLabel, m_column));
                    break;
            }
        ...
        public int CompareLabels(MapLabel label1, MapLabel label2, int col)
        {
            switch (col)
            {
                case 0: return String.Compare(label1.Text, label2.Text);
                case 1: return (int) (label1.Location.X - label2.Location.X);
                case 2: return (int)(label1.Location.Y - label2.Location.Y);
                case 3: return label1.Size - label2.Size;
                case 4: return String.Compare(Global.PointString(label1.Anchors[0].Location), Global.PointString(label2.Anchors[0].Location));
            }
            return 0;
        }
    }
