...
namespace WhereAreWe
{
    public partial class SheetOrganizerForm : HackerBasedForm
    {
        ...
        private void lvSheets_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            lvSheets.ListViewItemSorter = new MapSheetPairComparer(e.Column, m_bAscendingSort);
            lvSheets.Sort();
    ...
    class MapSheetPairComparer : IComparer
    {
        private int m_column;
        private bool m_bAscending;

        public MapSheetPairComparer()
        {
            m_column = 0;
            m_bAscending = true;
        }
        public MapSheetPairComparer(int column, bool bAscending)
        {
            m_column = column;
        ...
        public int Compare(object x, object y)
        {
            ...
            try
            {
                ...
                MapSheetPathInfo info1 = lvi1.Tag as MapSheetPathInfo;
                MapSheetPathInfo info2 = lvi2.Tag as MapSheetPathInfo;

                switch (m_column)
                {
                    case 0: returnVal = String.Compare(info1.Path, info2.Path); break;
                    case 1: returnVal = String.Compare(info1.Sheet.Title, info2.Sheet.Title); break;
                    case 2: returnVal = Math.Sign(info1.Zoom - info2.Zoom); break;
                    default: break;
                }
