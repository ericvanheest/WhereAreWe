...
namespace WhereAreWe
{
    ...
    public partial class EditBytesForm : CommonKeyForm
    {
        ...
        private void lvBytes_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            lvBytes.ListViewItemSorter = new EditByteItemComparer(e.Column, m_bAscendingSort);
            lvBytes.Sort();
        }
    }
    ...
    class EditByteItemComparer : IComparer
    {
        private int m_column;
        private bool m_bAscending;

        public EditByteItemComparer()
        {
            m_column = 0;
            m_bAscending = true;
        }

        public EditByteItemComparer(int column, bool bAscending)
        {
            m_column = column;
        ...
        public int Compare(object x, object y)
        {
            ...
            ByteItemTag item1 = (ByteItemTag)lvi1.Tag;
            ByteItemTag item2 = (ByteItemTag)lvi2.Tag;
            int returnVal = -1;
            ...
            switch (m_column)
            {
                case 0:
                    ...
                    break;
                case 1:
                    returnVal = Math.Sign(item1.Byte - item2.Byte);
                    break;
                case 2:
                    returnVal = String.Compare(item1.Description, item2.Description, true);
                    break;
                default:
                    break;
            }
