...
namespace WhereAreWe
{
    ...
    public partial class EditBitsForm : HackerBasedForm
    {
        ...
        {
            if (Properties.Settings.Default.DisplayReverseBitIndex)
        ...
        {
            miBitsDisplayReverse.Checked = Properties.Settings.Default.DisplayReverseBitIndex;
        ...
        private void miBitsDisplayReverse_Click(object sender, EventArgs e)
        {
            Properties.Settings.Default.DisplayReverseBitIndex = !Properties.Settings.Default.DisplayReverseBitIndex;
            miBitsDisplayReverse.Checked = Properties.Settings.Default.DisplayReverseBitIndex;
    ...
    public class BitDesc
    {
        ...
        public BitDesc(string setWhen, MapXY setWhere)
        {
            InitLists();
        ...
        public BitDesc AddSet(string when, MapXY where)
        {
            Set.Add(new WWW(WWW.Action.Set, when, where));
            return this;
        }
