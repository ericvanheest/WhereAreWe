...
namespace WhereAreWe
{
    ...
    public class BT3Character : BTCharacter
    {
        ...
        public override void SetCharFromStream(int iCharIndex, Stream stream, GameInfo info, EncounterInfo encounterInfo = null, bool bFromRosterFile = false)
        {
            ...
            Unknown44 = Global.Subset(RawBytes, 44, 2);
            Unknown100 = Global.Subset(RawBytes, 100, 20);
        ...
        public override void Serialize(Stream stream)
        {
            ...
            Global.SetBytes(bytes, 44, Unknown44);
            Global.SetBytes(bytes, 100, Unknown100);
    ...
    public class BT3Inventory : BTInventory
    {
        ...
        public override void SetBytes(byte[] bytes, int offset)
        {
            ...
            {
                int equipped = item.IsEquipped ? 0x01 : 0;
                bytes[iIndexItem * 3] = (byte)equipped;
