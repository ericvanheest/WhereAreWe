...
namespace WhereAreWe
{
    ...
    public class BT3Monster : BTMonster
    {
        ...
        public void SetBT3Bytes(int index, byte[] bytes, int offset = 0)
        {
            ...
            Unknown14 = bytes[offset + 0x14] & 0x3F;
            Unknown1E = bytes[offset + 0x1E];
            Unknown1F = bytes[offset + 0x1F];
            Unknown26 = bytes[offset + 0x26];
            ACIgnoreLow = bytes[offset + 0x2C];
            ACIgnoreHigh = bytes[offset + 0x2D];
        }
        ...
        public override byte[] GetBytes()
        {
            ...
            bytes[19] = (byte)(((InitialDistance) << 4) | AdvancePerRound);
            bytes[20] = (byte)(((int)Pronoun << 6) | Unknown14);
            ...
            bytes[0x2C] = (byte)ACIgnoreLow;
            bytes[0x2D] = (byte)ACIgnoreHigh;
            return bytes;
        }
        ...
        public override string MultiLineDescription
        {
            get
            {
                ...
                sb.AppendFormat("Ignores Target AC: {0}{1}\r\n", ACIgnoreLow, ACIgnoreLow == ACIgnoreHigh ? "" : String.Format("-{0}", ACIgnoreHigh));
