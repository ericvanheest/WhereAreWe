...
namespace WhereAreWe
{
    ...
    public class BT3SpellList : SpellList
    {
        ...
        public BT3SpellList()
        {
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.PhaseDoor, SpellType.Magician, 6, "PHDO", "Phase Door", 9, SpellWhen.AnywhereAnytime, SpellTarget.OneWall, SpellDuration.OneMove, "Allow passage through wall", "Turns almost any wall to air for exactly one move."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.Restoration, SpellType.Magician, 7, "REST", "Restoration", 12, SpellWhen.AnywhereAnytime, SpellTarget.Party, SpellDuration.Instant, "Heal all HP; Cure poison/nuts", "Regenerates the body of every party member to perfect condition; it even cures insanity or poisoning."));
            m_spells.Add(new BT3Spell(BT3SpellIndex.Deathstrike, SpellType.Magician, 7, "DEST", "Deathstrike", 14, SpellWhen.CombatAnywhere, SpellTarget.Monster10Feet, SpellDuration.Instant, "Kill enemy", "Very likely to instantly kill one selected enemy."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.WordOfFear, SpellType.Sorcerer, 2, "FEAR", "Word Of Fear", 4, SpellWhen.CombatAnywhere, SpellTarget.MonsterGroup, SpellDuration.Combat, "-1 To-Hit/Damage", "An incantation that causes a group of enemies to quake in fear, thus reducing their ability to attack and inflict damage."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.KylearansInvisibilitySpell, SpellType.Sorcerer, 3, "INVI", "Kylearan's Invisibility Spell", 6, SpellWhen.CombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "-4 AC", "An invocation that renders the entire party nearly invisible to the enemy."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.FanskarsForceFocus, SpellType.Wizard, 1, "FOFO", "Fanskar's Force Focus", 11, SpellWhen.CombatAnywhere, SpellTarget.MonsterGroup10Feet, SpellDuration.Instant, "24d4 damage", "Lands a cone of gravitational energy on a group of your Foes, inflicting 25 to 100 points of damage."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.ToArboria, SpellType.Chronomancer, 1, "ARBO", "To Arboria", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport to Arboria", "Teleports the party to Arboria if they are in the Skara Brae Wilderness at (6,14)."));
            m_spells.Add(new BT3Spell(BT3SpellIndex.FromArboria, SpellType.Chronomancer, 1, "ENIK", "From Arboria", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport from Arboria", "Teleports the party from Arboria back to Skara Brae."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.ToGelidia, SpellType.Chronomancer, 2, "GELI", "To Geledia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport to Geledia", "Teleports the party to Geledia if they are in the Skara Brae Wilderness at (0,0)."));
            m_spells.Add(new BT3Spell(BT3SpellIndex.FromGelidia, SpellType.Chronomancer, 2, "ECUL", "From Geledia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport from Geledia", "Teleports the party from Geledia back to Skara Brae."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.ToLucencia, SpellType.Chronomancer, 3, "LUCE", "To Lucencia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport to Lucencia", "Teleports the party to Lucencia if they are in the Skara Brae Wilderness at (17,2)."));
            m_spells.Add(new BT3Spell(BT3SpellIndex.FromLucencia, SpellType.Chronomancer, 3, "ILEG", "From Lucencia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport from Lucencia", "Teleports the party from Lucencia back to Skara Brae."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.ToKinestia, SpellType.Chronomancer, 4, "KINE", "To Kinestia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport to Kinestia", "Teleports the party to Kinestia if they are in the Skara Brae Wilderness at (2,16)."));
            m_spells.Add(new BT3Spell(BT3SpellIndex.FromKinestia, SpellType.Chronomancer, 4, "OBRA", "From Kinestia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport from Kinestia", "Teleports the party from Kinestia back to Skara Brae."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.ToTenabrosia, SpellType.Chronomancer, 5, "OLUK", "To Tenabrosia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport to Tenabrosia", "Teleports the party to Tenabrosia if they are in the Skara Brae Wilderness at (19,10)."));
            m_spells.Add(new BT3Spell(BT3SpellIndex.FromTenabrosia, SpellType.Chronomancer, 5, "ECEA", "From Tenabrosia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport from Tenabrosia", "Teleports the party from Tenabrosia back to Skara Brae."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.ToTarmitia, SpellType.Chronomancer, 6, "AECE", "To Tarmitia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport to Tarmitia", "Teleports the party to Tarmitia if they are in the Skara Brae Wilderness at (10,9)."));
            m_spells.Add(new BT3Spell(BT3SpellIndex.FromTarmitia, SpellType.Chronomancer, 6, "KULO", "From Tarmitia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport from Tarmitia", "Teleports the party from Tarmitia back to Skara Brae."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.ToMalefia, SpellType.Chronomancer, 7, "EVIL", "To Malefia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport to Malefia", "Teleports the party to Malefia if they are in the Skara Brae Wilderness at (18,18)."));
            m_spells.Add(new BT3Spell(BT3SpellIndex.FromMalefia, SpellType.Chronomancer, 7, "LIVE", "From Malefia", 9, SpellWhen.NonCombatAnywhere, SpellTarget.Party, SpellDuration.Instant, "Teleport from Malefia", "Teleports the party from Malefia back to Skara Brae."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.Gotterdamurung, SpellType.Miscellaneous, 1, "NUKE", "Gotterdamurung", 150, SpellWhen.CombatAnywhere, SpellTarget.AllMonsters, SpellDuration.Instant, "2000 damage", "The finest in offensive obliteration, this spell annihilates the opponent for 2000 damage points."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.BringaroundBallad, SpellType.Bard, 1, "", "Bringaround Ballad", 0, SpellWhen.AnywhereAnytime, SpellTarget.Party, SpellDuration.Short, "+? HP", "In non-combat situations, this rejuvenates the Bard's hit points.  During combat, this song will affect everyone in your party, including the Bard. (90 min)."));
            m_spells.Add(new BT3Spell(BT3SpellIndex.RhymeOfDuotime, SpellType.Bard, 1, "", "Rhyme of Duotime", 0, SpellWhen.AnywhereAnytime, SpellTarget.Party, SpellDuration.Short, "+? SP regen, +? attacks", "In non-combat situations, this regenerates the mage's spell points.  During combat, it gives the party an extra attack. (90 min)."));
            ...
            m_spells.Add(new BT3Spell(BT3SpellIndex.MinstrelShield, SpellType.Bard, 1, "", "Minstrel Shield", 0, SpellWhen.AnywhereAnytime, SpellTarget.Party, SpellDuration.Short, "-? AC, half damage", "In non-combat situations, this lowers your armor class.  During combat, it also partially shields your party so they only take half damage from monster attacks. (90 min)."));
        }
    }
    ...
    public class BT3Spell : BTSpell
    {
        ...
        private string WhereLearned(BT3SpellIndex index)
        {
            switch (Index)
            {
                case BT3SpellIndex.GillesGills: return "From Fisherman in Arboria (1,11) for 500 Gold";
                default: return "";
            }
        }
