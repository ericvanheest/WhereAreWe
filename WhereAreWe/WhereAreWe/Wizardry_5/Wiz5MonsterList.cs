...
namespace WhereAreWe
{
    ...
    public class Wiz5Treasure : WizTreasure
    {
            ...
            get
            {
                ...
                for (int i = 0; i < 16; i++)
                {
                    if (Wiz5Traps.HasFlag((Wiz5TrapFlags)(1 << i)))
                        sb.AppendFormat("{0}, ", GetTrapName((Wiz5Trap)i));
                }
                return Global.Trim(sb).ToString();
            }
        }

        public static string GetTrapName(Wiz5Trap trap)
        {
            switch (trap)
            {
        ...
        public Wiz5Treasure(byte[] bytes, int offset = 0)
        {
            ...
            m_iTrapsFlag = BitConverter.ToUInt16(bytes, offset + 2);
        ...
        public static Wiz5Trap[] AllWiz5Traps
        {
            get
            {
                Wiz5Trap[] traps = new Wiz5Trap[(int) Wiz5Trap.Last];
                for(Wiz5Trap trap = Wiz5Trap.TraplessChest; trap < Wiz5Trap.Last; trap++)
                    traps[(int) trap] = trap;
                return traps;
            }
        }
