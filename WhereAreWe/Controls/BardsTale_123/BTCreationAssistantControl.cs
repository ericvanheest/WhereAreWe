...
namespace WhereAreWe
{
    public partial class BTCreationAssistantControl : CreationAssistantControl
    {
        ...
        private void lvPrevious_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            lvPrevious.ListViewItemSorter = new BTDiceRollsComparer(lvPrevious, e.Column, m_bAscendingSort);
            lvPrevious.Sort();
        }
    ...
    class BTDiceRollsComparer : BasicListViewComparer
    {
        public BTDiceRollsComparer(ListView lv, int column, bool bAscending) : base(lv, column, bAscending) { }
