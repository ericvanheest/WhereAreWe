...
//            labelSideQuest.Text = MM2Character.QuestString(mm2Char.Quest, mm2Char.CastleQuestStatus);
    ...
    public class MM2Character : MMBaseCharacter
    {
        ...
        public override void SetCharFromStream(int iCharIndex, Stream stream, GameInfo info = null, EncounterInfo encounterInfo = null, bool bFromRosterFile = false, byte[] itemList = null)
        {
